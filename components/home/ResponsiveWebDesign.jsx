...
export default function ResponsiveWebDesign() {
  return (
    <section id="services" className="relative overflow-hidden bg-white py-16 md:py-24">
      ...
      <AnimatedSection className="relative z-20 mx-auto max-w-6xl px-6">
        <div className="pointer-events-none absolute inset-0 bg-grid-pattern" />
        <CharReveal text="Responsive Web Design & Development" className="text-center font-bold text-[#010914] sm:text-center" />
